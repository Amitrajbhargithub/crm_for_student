    ...
    {{-- <div class="row">
      <div class="col-md-12">
        <div class="d-flex flex-column align-items-center">
          <img id="profile-preview" class="rounded-circle mt-5" width="150px" @if(!empty(Auth::user()->image)) @else src="https://st3.depositphotos.com/15648834/17930/v/600/depositphotos_179308454-stock-illustration-unknown-person-silhouette-glasses-profile.jpg" @endif>
        ...
        <div class="row">
            <div class="col-md-12 border-right">
                <div class="p-3 py-5">
                  ...
                  @endif
                    <form action="" enctype="multipart/form-data">@csrf
